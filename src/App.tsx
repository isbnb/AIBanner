...
function App() {
  ...
  const downloadPNG = async () => {
    ...
    try {
      ...
      setError('Failed to convert to PNG. Please try downloading as SVG instead.');
    }
  };
          ...
          {analysisResult && (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Color Palette (2 Colors Max)</h3>
                  <div className="flex gap-3">
                    {analysisResult.colors.slice(0, 2).map((color, index) => (
          ...
          {svgContent && (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-6 h-6 text-green-500" />
                  <h2 className="text-xl font-semibold text-gray-900">Your AI-Generated Promotional Banner is Ready!</h2>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6 overflow-hidden">
                ...
                <p className="text-sm text-gray-600 text-center mt-4">
                  Preview scaled to 50% • Full size: 1200×630px • AI-generated promotional content
                </p>
              </div>
            </div>
          )}
